...
![Hexo 默认首页](https://r2.chitang.dev/images/hexo-vercel-blog/hexo-default.png)
...
![添加项目](https://r2.chitang.dev/images/hexo-vercel-blog/vercel-add.png)
...
![.vercel.app 域名](https://r2.chitang.dev/images/hexo-vercel-blog/vercel-app-domain.png)
...
![添加站点](https://r2.chitang.dev/images/hexo-vercel-blog/cf-add-website.png)

在里面输入你注册的域名，如果出现 `your.domain is not a registered domain` 的提示建议等待半小时左右再试

计划选择 Free 足够

![计划选择](https://r2.chitang.dev/images/hexo-vercel-blog/cf-plan.png)

在下一页的 DNS 记录中，可能会有注册商自带的一些记录，我的推荐是全部删除

![DNS 记录](https://r2.chitang.dev/images/hexo-vercel-blog/cf-dns.jpg)

弹出的警告直接确认

![警告](https://r2.chitang.dev/images/hexo-vercel-blog/cf-warn.png)

在下一页会要求将域名的名称服务器(即 Nameserver)更改为 Cloudflare 提供给你个人的服务器

![Nameserver](https://r2.chitang.dev/images/hexo-vercel-blog/cf-nameserver.png)
...
![顶级域名](https://r2.chitang.dev/images/hexo-vercel-blog/vercel-domain.png)
...
![DNS 记录](https://r2.chitang.dev/images/hexo-vercel-blog/cf-dns-record.png)
